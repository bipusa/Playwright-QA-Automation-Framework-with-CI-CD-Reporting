...
let apiUtils;
let maintoken;
const loginPayload = { email: "thapa.bipusa@outlook.com", password: "Eventhub@1234" };
...
test.beforeAll(async () => {
    ...
    maintoken = await apiUtils.gettoken();
...
test("sandbox banner hidden intercept", async ({ page }) => {
    await page.addInitScript(value => {
        window.localStorage.setItem('eventhub_token', value);
    }, maintoken);
